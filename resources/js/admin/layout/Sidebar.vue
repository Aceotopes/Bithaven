...
<template>
    <aside
        class="fixed lg:top-22 lg:left-7 lg:bottom-6 lg:w-65 top-0 left-0 bottom-0 w-80 bg-white dark:bg-gray-800 lg:rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col p-8 transition-all duration-300"
    >
        <!-- Mobile Close -->
        ...
        <nav class="flex flex-col gap-3 text-[15px]">
            ...
            <RouterLink
                ...
                class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-200"
                :class="
                    route.path.startsWith('/admin/live')
                        ? 'bg-cyan-500 text-white shadow-lg'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700'
                "
            >
            ...
            <RouterLink
                ...
                class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-200"
                :class="
                    route.path.startsWith('/admin/students')
                        ? 'bg-cyan-500 text-white shadow-lg'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700'
                "
            >
            ...
            <RouterLink
                ...
                class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-200"
                :class="
                    route.path.startsWith('/admin/financials')
                        ? 'bg-cyan-500 text-white shadow-lg'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-700'
                "
            >
